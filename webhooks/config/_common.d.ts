...
type T1 = C<{en: string; fr: string}>; // config.json:root.locale.query_select_publication_first, config.json:root.locale.query_select_publication_second, config.json:root.locale.read_toc, config.json:root.locale.read_toc_no_response, config.json:root.locale.remaining_time_hours, config.json:root.locale.remaining_time_minutes
type T2 = C<{
  query_select_publication_first: T1;
  query_select_publication_second: T1;
  read_toc: T1;
  read_toc_no_response: T1;
  remaining_time_hours: T1;
  remaining_time_minutes: T1;
