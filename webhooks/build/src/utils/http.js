...
exports.httpFetchFormattedResponse = exports.httpFetchRawResponse = void 0;
const node_fetch_1 = require("node-fetch");
const https = require("https");
const DEFAULT_HTTP_TIMEOUT = 30000;
const debug = console.log;
async function httpFetchRawResponse(url, options = {}, locale = "fr-FR") {
    options.headers = options.headers instanceof node_fetch_1.Headers
        ? options.headers
        : new node_fetch_1.Headers(options.headers || {});
...
exports.httpFetchRawResponse = httpFetchRawResponse;
const handleCallback = async (res, callback) => {
    if (callback) {
...
async function httpFetchFormattedResponse(url, options, callback, locale) {
    let result = {
        isFailure: true,
        isSuccess: false,
        url,
...
exports.httpFetchFormattedResponse = httpFetchFormattedResponse;
