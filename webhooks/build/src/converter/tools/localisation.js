...
exports.convertContributorArrayToStringArray = exports.convertMultiLangStringToString = void 0;
...
function convertMultiLangStringToString(items) {
    if (typeof items === "object") {
        // FIXME: main DI inside common utils!!
        // const translator = diMainGet("translator");
        const langs = Object.keys(items);
        const lang = langs.filter((l) => l.toLowerCase().includes(/*translator.getLocale().toLowerCase())*/ 'fr'));
        const localeLang = lang[0];
        return items[localeLang] || items._ || items[langs[0]];
    }
    return items || "";
}
exports.convertMultiLangStringToString = convertMultiLangStringToString;
...
function convertContributorArrayToStringArray(items) {
    if (!items) {
        return [];
    }
...
exports.convertContributorArrayToStringArray = convertContributorArrayToStringArray;
